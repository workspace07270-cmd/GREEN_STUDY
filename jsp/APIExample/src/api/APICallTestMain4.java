...
public class APICallTestMain4 {

	public static void main(String[] args) {
		try {
			// 1. URL 셋팅
			String apiURL = "https://apis.data.go.kr/B090041/openapi/service/AstroEventInfoService/getAstroEventInfo?serviceKey=";
			// 2. 인증키 및 파라미터 셋팅
...
//			conn.setReadTimeout(10000);
	...
	private static void parseXML(String xmlStr) throws Exception{
		...
		for(int i=0;i<list.getLength();i++) {
			...
			System.out.println("astroTitle : " + getElementValue(item, "astroTitle"));
			System.out.println( "locdate : " + getElementValue(item, "locdate"));
			System.out.println("astroTime : " + getElementValue(item, "astroTime"));
			System.out.println("astroEvent : " + getElementValue(item, "astroEvent"));
			System.out.println("-----");
		}
