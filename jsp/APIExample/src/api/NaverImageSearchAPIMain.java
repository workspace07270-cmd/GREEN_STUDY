...
public class NaverImageSearchAPIMain {
	 public static void main(String[] args) {
	        ...
	        String text = null;
	        try {
	            text = URLEncoder.encode("국립중앙박물관", "UTF-8");
		 ...
		 private static void parseJSON(String string) {
				...
				for(int i=0;i<arr.length();i++) {
					...
					System.out.println(arr.getJSONObject(i).getString("thumbnail"));
					System.out.println(arr.getJSONObject(i).getString("sizeheight"));
					System.out.println(arr.getJSONObject(i).getString("sizewidth"));
					System.out.println("--------------------------------");
